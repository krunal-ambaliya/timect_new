...
export default function Recommended() {
  const defaultImage = '/images/right-main.png';
  ...
  return (
    <section className="grid md:grid-cols-2 gap-0 mb-16">
      ...
      <div className="px-4 md:px-8 py-6 md:py-12">
        ...
        <div className="grid grid-cols-3 gap-6" onMouseLeave={() => setMainImage(defaultImage)}>
          
          <div className="text-center cursor-pointer" onMouseEnter={() => setMainImage('/images/image_2.png')}>
          ...
          <div className="text-center cursor-pointer" onMouseEnter={() => setMainImage('/images/image_4.png')}>
