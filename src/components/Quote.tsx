export default function Quote() {
  return (
    <section className="bg-[#f4f4f2] py-16 text-center">
      <img src="https://res.cloudinary.com/dphscxzb4/image/upload/v1784048492/timect/timect_logo.png" alt="Seiko Logo" className="w-14 h-14 rounded-full mx-auto mb-5 object-contain" />
