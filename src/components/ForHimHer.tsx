    ...
    <section className="max-w-[1400px] mx-auto px-8 pb-16">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="relative h-[420px] flex items-end justify-start p-8" style={{ background: 'linear-gradient(160deg,#d9d9d9,#bbb)' }}>
          <img src="https://res.cloudinary.com/dphscxzb4/image/upload/v1784048483/timect/man_watch_cat.jpg" alt="For Him" className="absolute inset-0 w-full h-full object-cover opacity-60" />
        ...
        <div className="relative h-[420px] flex items-end justify-start p-8" style={{ background: 'linear-gradient(160deg,#2a2a2a,#000)' }}>
          <img src="https://res.cloudinary.com/dphscxzb4/image/upload/v1784048495/timect/woman_watch_cat.jpg" alt="For Her" className="absolute inset-0 w-full h-full object-cover opacity-60" />
          <div className="relative z-10">
